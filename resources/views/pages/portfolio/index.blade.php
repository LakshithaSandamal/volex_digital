                    ...
                    <div class="we-services">
						    ...
						    <div class="digital-services">
						        <div class="digital-wel s1-item">
                                    <div class="digital-img">
                                        <a class="digital-icon" href="#"><img src="{{ asset('img/icon/a.png') }}" alt=""></a>
                                    </div>
				        ...
				        <div class="col-md-3 col-sm-4 col-xs-12">
							<div class="digital-services">
								<div class="digital-wel s2-item">
                                    <div class="digital-img">
                                        <a class="digital-icon" href="#"><img src="{{ asset('img/icon/a2.png') }}" alt=""></a>
                                    </div>
									<div class="digital-content">
				        ...
				        <div class="col-md-3 col-sm-4 col-xs-12">
							<div class="digital-services">
								<div class="digital-wel s4-item">
                                    <div class="digital-img">
                                        <a class="digital-icon" href="#"><img src="{{ asset('img/icon/a3.png') }}" alt=""></a>
                                    </div>
									<div class="digital-content">
				        ...
				        <div class="col-md-3 col-sm-4 col-xs-12">
							<div class="digital-services">
								<div class="digital-wel s3-item">
                                    <div class="digital-img">
                                        <a class="digital-icon" href="#"><img src="{{ asset('img/icon/a4.png') }}" alt=""></a>
                                    </div>
									<div class="digital-content">
										<h4>Solar & Energy</h4>
									</div>
				        ...
				        <div class="col-md-offset-3 col-md-3 col-sm-4 col-xs-12">
							<div class="digital-services">
								<div class="digital-wel s5-item">
                                    <div class="digital-img">
                                        <a class="digital-icon" href="#"><img src="{{ asset('img/icon/a5.png') }}" alt=""></a>
                                    </div>
									<div class="digital-content">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
							<div class="digital-services">
								<div class="digital-wel s5-item">
                                    <div class="digital-img">
                                        <a class="digital-icon" href="#"><img src="{{ asset('img/icon/a6.png') }}" alt=""></a>
                                    </div>
									<div class="digital-content">
